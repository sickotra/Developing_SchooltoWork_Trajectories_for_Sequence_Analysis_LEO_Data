...
</p> This code analyses the **Longitudinal Educations Outcomes (LEO) Standard Extract** which connects the education and employment data of individuals. Data access was obtained through the Office for National Statistics Secure Research Service. </p>

</p> LEO Iteration 1 includes data from the:

* UK Department for Education - National Pupil Database (NPD), Individualised Learner Record (ILR), Higher Education Statistics Agency (HESA)

* UK Department for Work and Pensions (DWP) - Employment, Self-Employment data (collected by HM Revenue and Customs)

* UK DWP - Benefits and Geography data </p>

</p> This code uses the Spring School Census from the NPD, the National Client Caseload Information System (NCCIS) from the NPD, HESA, DWP Employment, Self-employment and Benefits data to create a longitudinal record of the yearly activity histories for 556,182 individuals from the 2010/11 school-leaver cohort in England.</p>

</p>The cohort is extracted from the NPD School Census data and linked to socio-demographic characteristics. The activity histories begin from the first non-compulsory observed state in 2011/12 until the 2018/19 academic year. This corresponds to ages 16/17 to ages 23/24. </p>
