...
SELECT DISTINCT
	...
	-- Select variable from the Earnings tables
	Earnings.earnings
...
-- Link to Earnings table, alias Earnings
INNER JOIN [LEO].[2002237].[LEO_Earnings] Earnings
	ON AEID_EDUKEY.edukey = Earnings.Edukey
